	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">{{ trans('phrases.register') }}</div>
				<div class="panel-body">
					...
					{!! Form::open(['action' => 'Auth\AuthController@postRegister', 'class' => 'form-horizontal', 'files' => true]) !!}
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								{!! Form::submit(trans('buttons.register'), ['class' => 'btn btn-primary']) !!}
							</div>
						</div>
					{!! Form::close() !!}
				</div>
